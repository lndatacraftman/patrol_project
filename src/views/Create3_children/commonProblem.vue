    ...
    <div class="countain">
      ...
      <div class="countain_tablebox">
        ...
        <div class="countain_table" @click="fn">
          ...
          <!-- 下转后的echarts图 -->
          <div class="echarts_table" style="width:350px;height:150px" ref="table6" v-show="willshow"></div>
        </div>
      </div>
    </div>
</div>
  ...
  mounted () {
    const option = {
      ...
      xAxis: [{
        ...
        boundaryGap: true,
        data: ['企业', '市政府机构', '事业单位', '开发区', '市委单位', '群团', '人大政协法院', '大学']
    ...
    const option1 = {
      ...
      color: ['orange', 'yellow', '#2bfaff', 'dodgerblue', 'royalblue', 'rgb(191, 255, 127)'],
      legend: {
        orient: 'vertical',
        itemWidth: 9,
        itemHeight: 9,
        ...
        data: ['党的意识、政治建设', '担当作为、履行职责使命', '履行全面从严治党“两个责任”', '落实深化改革要求', '班子建设和队伍建设', '机关党建和基层党组织建设']
      },
      series: [
        {
          name: '访问来源',
      ...
      xAxis: [
        {
          ...
          data: ['学习贯彻习近平总书记重要讲话和指示批示精神情况', '执行和落实制度情况', '履行核心职能情况', '干部担当作为情况', '领导班子建设情况']
        }
      ],
      yAxis: [
        {
...
#commonproblem > .countain > .countain_tablebox > .countain_table > .echarts_table {
  width: 100%;
  height: 100%;
}
</style>
